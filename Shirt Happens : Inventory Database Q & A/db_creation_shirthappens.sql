...
BEGIN
    ...
    DECLARE brand ENUM('Marimekko', 'Makia', 'Finlayson', 'Halti','Dressman');
    DECLARE color ENUM('Red', 'Blue', 'Black', 'White','Green','Yellow');
    ...
    WHILE counter < max_records DO
        ...
        SET brand = ELT(FLOOR(1 + RAND() * 4), 'Marimekko', 'Makia', 'Finlayson', 'Halti','Dressman');
        SET color = ELT(FLOOR(1 + RAND() * 4), 'Red', 'Blue', 'Black', 'White','Green','Yellow');
